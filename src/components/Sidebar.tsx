        ...
        <div>
          <ul className="space-y-1">
            <li>
              ...
              >
                <svg className="icon-standard flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <ul className="space-y-1">
            ...
            {saved.filter((v) => v.showInSidebar !== false).map((v) => (
                <li key={v.id} className="group flex items-center">
                  ...
                  >
                    {v.isDefault ? (
                      <span className="icon-standard flex items-center justify-center flex-shrink-0">⭐</span>
                    ) : v.icon ? (
                      <span className="icon-standard flex items-center justify-center flex-shrink-0">{v.icon}</span>
                    ) : (
                      <svg className="icon-standard flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
